...
/// <summary>
/// SGuard-localized version of UrlAttribute. This class acts as a wrapper for the sealed <see cref="UrlAttribute"/> 
/// to provide support for localized error messages.
/// </summary>
[AttributeUsage(AttributeTargets.Property | AttributeTargets.Field | AttributeTargets.Parameter)]
public class SGuardUrlAttribute : SGuardValidationAttributeBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SGuardUrlAttribute"/> class.
    /// </summary>
    ...
    public SGuardUrlAttribute(Type resourceType, string resourceName) : base(resourceType, resourceName) { }
